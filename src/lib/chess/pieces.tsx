...
export const BlackQueen: React.FC<PieceProps> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className}>
    <g fill="#000" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const BlackBishop: React.FC<PieceProps> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
      ...
      <path d="M17.5 26h10m-12.5 4h15m-7.5-14.5v5M20 18h5" stroke="#fff" strokeLinejoin="miter"/>
    </g>
  </svg>
);
...
export const getPieceComponent = (color: 'w' | 'b', type: string): React.FC<PieceProps> | null => {
  const key = `${color}${type}`;
  return chessPieces[key] || null;
};
